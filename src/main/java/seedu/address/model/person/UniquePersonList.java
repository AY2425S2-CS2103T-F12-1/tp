...
public class UniquePersonList implements Iterable<Person> {
    ...
    /**
     * Returns true if the list contains a string equivalent person as the given argument.
     */
    public boolean containsStringEquivalentPerson(String toCheck) {
        requireNonNull(toCheck);
        return internalList.stream().anyMatch(person -> person.getName().fullName.equals(toCheck));
    }
